#!/usr/bin/env python3
"""
Spanish Asylum Appointment Bot - Main Entry Point (Selenium Version)
...
from asylum_bot_selenium import AsylumAppointmentBotSelenium
...
async def main():
    ...
    try:
        ...
        bot = AsylumAppointmentBotSelenium(telegram_token, chat_id)
        
        logger.info("Starting Spanish Asylum Appointment Bot (Selenium Version)...")
